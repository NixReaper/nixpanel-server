  ...
  return (
    <div className="space-y-4 max-w-xl">
      <div className="flex items-center gap-2 text-sm">
        ...
        <span className="text-white">Email All Users</span>
      </div>
      <div>
        <h1 className="text-white text-xl font-semibold">Email All Users</h1>
        <p className="text-[#64748b] text-sm">Send a bulk email to all account holders.</p>
      </div>
      <div className="bg-[#1a1d27] border border-[#2a2d3e] rounded-xl p-8 flex flex-col items-center gap-4 text-center">
        ...
        <div>
          ...
          <p className="text-white font-semibold text-lg mb-1">Email All Users</p>
          <p className="text-[#64748b] text-sm max-w-sm">
            This feature will allow you to compose and send a bulk email to all hosting account holders simultaneously.
          </p>
        </div>
      </div>
    </div>
