...
export default function CreateAccount() {
  ...
  useEffect(() => {
    api.get('/nixserver/packages').then(r => setPackages(r.data.data)).catch(() => {})
  }, [])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true)
    try {
      await api.post('/nixserver/accounts', {
        ...form,
    ...
    <div className="max-w-xl">
      ...
      <form onSubmit={handleSubmit} className="bg-[#1a1d27] border border-[#2a2d3e] rounded-xl p-6 space-y-4">
        ...
        {[
          ...
          { key: 'password', label: 'NixClient Password', type: 'password', placeholder: '••••••••', hint: 'Min 8 characters' },
