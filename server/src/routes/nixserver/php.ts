...
export default async function phpRoutes(fastify: FastifyInstance) {
  // GET /api/nixserver/php/versions — list installed PHP versions
  ...
  // GET /api/nixserver/php/accounts — list which PHP version each account uses
  ...
  // PUT /api/nixserver/php/accounts/:id — change PHP version for account
...
`
  ...
  // GET /api/nixserver/php/ini/:version — get php.ini settings
