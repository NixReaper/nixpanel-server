...
export default async function securityRoutes(fastify: FastifyInstance) {
  // GET /api/nixserver/security/events
  ...
  // POST /api/nixserver/security/events/:id/resolve
  ...
  // GET /api/nixserver/security/blocked-ips
  ...
  // POST /api/nixserver/security/blocked-ips
  ...
  // DELETE /api/nixserver/security/blocked-ips/:id
  ...
  // GET /api/nixserver/security/whitelisted-ips
  ...
  // POST /api/nixserver/security/whitelisted-ips
  ...
  // DELETE /api/nixserver/security/whitelisted-ips/:id
  ...
  // GET /api/nixserver/security/fail2ban
  ...
  // GET /api/nixserver/security/fail2ban/:jail
