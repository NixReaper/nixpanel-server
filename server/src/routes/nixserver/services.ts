...
export default async function serviceRoutes(fastify: FastifyInstance) {
  // GET /api/nixserver/services — list all managed services and their status
  ...
  // GET /api/nixserver/services/:name
  ...
  // POST /api/nixserver/services/:name — start/stop/restart/reload/enable/disable
