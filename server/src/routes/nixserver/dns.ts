...
export default async function dnsRoutes(fastify: FastifyInstance) {
  ...
  // POST /api/nixserver/dns/:id/records
  ...
  // PUT /api/nixserver/dns/:zoneId/records/:recordId
  ...
  // DELETE /api/nixserver/dns/:zoneId/records/:recordId
  ...
  // POST /api/nixserver/dns/:id/reload
