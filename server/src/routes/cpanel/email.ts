...
export default async function cpanelEmailRoutes(fastify: FastifyInstance) {
  ...
  // GET /api/cpanel/email/forwarders
  ...
  // POST /api/cpanel/email/forwarders
  ...
  // DELETE /api/cpanel/email/forwarders/:id
