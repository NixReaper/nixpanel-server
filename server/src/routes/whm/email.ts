...
export default async function emailRoutes(fastify: FastifyInstance) {
  ...
  // POST /api/whm/email/:id/password
  ...
  // GET /api/whm/email/forwarders?accountId=
  ...
  // DELETE /api/whm/email/forwarders/:id
