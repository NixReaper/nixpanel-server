...
export default async function accountRoutes(fastify: FastifyInstance) {
  ...
  // POST /api/whm/accounts/:id/suspend
  ...
  // POST /api/whm/accounts/:id/unsuspend
