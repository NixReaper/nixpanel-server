...
export default async function backupRoutes(fastify: FastifyInstance) {
  // POST /api/whm/backup/account/:id — backup a single account
  ...
  // POST /api/whm/backup/server — full server backup
  ...
  // GET /api/whm/backup/list — list available backups
  ...
  // DELETE /api/whm/backup — delete a backup file
  ...
  // POST /api/whm/backup/restore/:filename
